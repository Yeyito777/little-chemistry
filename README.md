...
Minecraft's built-in item, block, and entity registries remain immutable after bootstrap. Little Chemistry registers only a small fixed set of carrier items, one carrier block, and four movement/disposition carrier entity types as engine infrastructure; arbitrary logical content is created in the server-owned virtual registry at runtime.
