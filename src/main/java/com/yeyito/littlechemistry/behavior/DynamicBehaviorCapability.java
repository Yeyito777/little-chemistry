...
public enum DynamicBehaviorCapability {
	...
	PROJECTILE_CREATED("projectileCreated", ProjectileCreatedBehavior.class),
	PROJECTILE_IMPACT("projectileImpact", ProjectileImpactBehavior.class),
	PROJECTILE_WEAPON_RELEASE("projectileWeaponRelease", ProjectileWeaponReleaseBehavior.class),
	PROJECTILE_WEAPON_USE_TICK("projectileWeaponUseTick", ProjectileWeaponUseTickBehavior.class),
