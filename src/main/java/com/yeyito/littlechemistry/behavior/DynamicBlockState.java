...
public final class DynamicBlockState {
	...
	public void setString(String key, String value) { blockEntity().setGeneratedState(key, value); }
	public int getInt(String key, int fallback) {
		try { return Integer.parseInt(getString(key, Integer.toString(fallback))); }
		catch (NumberFormatException ignored) { return fallback; }
	}
	public void setInt(String key, int value) { setString(key, Integer.toString(value)); }
	...
	public void setBoolean(String key, boolean value) { setString(key, Boolean.toString(value)); }
	public void remove(String key) { setString(key, null); }
	public Map<String, String> snapshot() { return blockEntity().generatedStateSnapshot(); }
